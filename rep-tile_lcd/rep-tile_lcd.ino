  ...
  switch (currentState) {
    ...
    case PREP:
      if (btn) {
        ...
        updateOLED(
          "R1: " + shapeDatabase[activeRoundShapes[0]].name,
          "R2: " + shapeDatabase[activeRoundShapes[1]].name,
          "R3: " + shapeDatabase[activeRoundShapes[2]].name,
          "Press to begin"
        );
        delay(500); 
      }
    ...
    case GAME_SETUP:
      ...
      if (btn) {
        ...
        updateOLED("ROUND 1", "Shape: " + shapeName, "", "Press to Start");
        delay(500);
      }
      break;
    ...
    case SCORING:
      if (btn) {
        ...
        if (currentRound > 3) {
          ...
          updateOLED("ROUND " + String(currentRound), "Shape: " + nextShape, "", "Press to Start");
        }
        delay(500);
      }
      break;
